...
import {cursorHover, CustomTooltipContent, DefaultTooltip} from "@/components/common/tooltip";
...
export default function PlayerInsightsV2({playerProfile, category}: PlayerInsightsV2Props) {
  ...
  const generateInsightsData = () => {
    ...
    const positionMetrics = [
      {
        metric: 'Goals/Game',
        player: performanceStats.goals / performanceStats.appearances,
        league: 0.4,
        category: position
      },
  ...
  const renderPerformanceTab = () => (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          ...
          <StatCard title="Goals" value={data.performanceStats.goals}
                    subtitle={`${data.performanceStats.appearances} apps`} trend="stable"/>
          <StatCard title="Assists" value={data.performanceStats.assists} subtitle="This season" trend="up"/>
          <StatCard title="Pass Accuracy" value={`${data.performanceStats.passAccuracy}%`} subtitle="League: 82%"
                    trend={data.performanceStats.passAccuracy > 82 ? "up" : "down"}/>
          <StatCard title="Duels Won" value={`${data.performanceStats.duelsWon}%`} subtitle="Success rate"
                    trend="stable"/>
          ...
          <div className="bg-background rounded-lg shadow-md p-6">
            ...
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={data.gamePerformance}>
                ...
                <XAxis dataKey="game"/>
                <YAxis/>
                <Tooltip content={<CustomTooltipContent/>} cursor={cursorHover}/>
                <Legend/>
  ...
  const renderMarketTab = () => (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          ...
          <StatCard title="Monthly Inquiries" value={data.marketData[11]?.inquiries} subtitle="From clubs"
                    trend="stable"/>
          ...
          <div className="bg-background rounded-lg shadow-md p-6">
            ...
            <ResponsiveContainer width="100%" height={280}>
              <AreaChart data={data.marketData}>
                ...
                <YAxis/>
                {/*<Tooltip content={<CustomTooltipContent/>} cursor={cursorHover}/>*/}
                <Tooltip formatter={(value) => [`€${value}K`]} content={<CustomTooltipContent/>} cursor={cursorHover}/>
  ...
  const renderDevelopmentTab = () => (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          ...
          <StatCard title="Fitness Level" value={`${data.fitnessData[11]?.fitness}%`} subtitle="Current"
                    trend="stable"/>
