-- =====================================================
-- Add club_avg_market_value_eur to get_agent_roster
-- =====================================================
...
RETURNS TABLE (
  ...
  club_country TEXT,
  club_avg_market_value_eur INTEGER,  -- NEW FIELD
  league_id TEXT,
  league_name TEXT,
  league_tier INTEGER,
  league_country TEXT,
...
BEGIN
  ...
  SELECT
    ...
    c.avg_market_value_eur::INTEGER as club_avg_market_value_eur,  -- NEW FIELD
    c.league_id::TEXT,
...
SELECT '✅ Added club_avg_market_value_eur to roster!' as status;
