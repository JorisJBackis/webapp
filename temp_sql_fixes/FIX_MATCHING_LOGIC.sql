-- =====================================================
-- FIX match_roster_with_needs function
-- Changes:
...
BEGIN
  ...
  WITH player_matches AS (
    ...
    JOIN clubs_transfermarkt c ON rn.created_by_club_id = c.id
    CROSS JOIN (
      SELECT p.*
...
SELECT '✅ Matching logic fixed - now requires 3+ exact matches!' as status;
