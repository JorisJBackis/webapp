...
-- 1. Recreate get_agent_roster function with correct types
...
-- 2. Recreate match_roster_with_needs function with correct types
...
SELECT '✅ Functions recreated successfully with correct types!' as status;
