-- =====================================================
-- Add actual player values to match_reasons for tooltips
-- =====================================================
...
BEGIN
  ...
  WITH player_matches AS (
    SELECT
      ...
      -- Player actual values
      p.main_position as player_position,
      p.age as player_age,
      p.height as player_height,
      p.foot as player_foot,
...
SELECT '✅ Function updated with player values for tooltips!' as status;
